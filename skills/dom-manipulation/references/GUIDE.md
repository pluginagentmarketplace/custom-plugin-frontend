...
This guide provides comprehensive documentation for the **dom-manipulation** skill in the custom-plugin-frontend plugin.
...
```bash
# Invoke the skill
claude "dom-manipulation - [your task description]"

# Example
claude "dom-manipulation - analyze the current implementation"
```
...
def implement_dom_manipulation(input_data):
    """
    Implement dom-manipulation functionality.
