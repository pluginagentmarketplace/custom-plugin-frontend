...
This guide provides comprehensive documentation for the **internet-basics** skill in the custom-plugin-frontend plugin.
...
```bash
# Invoke the skill
claude "internet-basics - [your task description]"

# Example
claude "internet-basics - analyze the current implementation"
```
...
def implement_internet_basics(input_data):
    """
    Implement internet-basics functionality.
