...
This guide provides comprehensive documentation for the **asset-optimization** skill in the custom-plugin-frontend plugin.
...
```bash
# Invoke the skill
claude "asset-optimization - [your task description]"

# Example
claude "asset-optimization - analyze the current implementation"
```
...
def implement_asset_optimization(input_data):
    """
    Implement asset-optimization functionality.
