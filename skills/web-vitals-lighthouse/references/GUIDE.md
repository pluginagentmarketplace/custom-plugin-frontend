# Web Vitals Lighthouse Guide

## Overview

This guide provides comprehensive documentation for the **web-vitals-lighthouse** skill in the custom-plugin-frontend plugin.
...
```bash
# Invoke the skill
claude "web-vitals-lighthouse - [your task description]"

# Example
claude "web-vitals-lighthouse - analyze the current implementation"
```
...
def implement_web_vitals_lighthouse(input_data):
    """
    Implement web-vitals-lighthouse functionality.
