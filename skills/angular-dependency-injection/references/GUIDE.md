...
This guide provides comprehensive documentation for the **angular-dependency-injection** skill in the custom-plugin-frontend plugin.
...
```bash
# Invoke the skill
claude "angular-dependency-injection - [your task description]"

# Example
claude "angular-dependency-injection - analyze the current implementation"
```
...
def implement_angular_dependency_injection(input_data):
    """
    Implement angular-dependency-injection functionality.
